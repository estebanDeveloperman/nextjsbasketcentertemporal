const staffImages = [
  ...
  },
  {
    ...
    text: [
      ...
      "CAMPEÓN ADECOPA",
      "EX ENTRENADOR CLUB DE REGATAS LIMA",
      "ENTRENADOR Y COORDINADOR EN CAMBRIDGE COLLEGE",
      "ESPECIALISTA EN SCOUTING Y VIDEO ANÁLISIS",
    ],
  },
  {
    ...
    text: [
      ...
      "ENTRENADOR SCOUTING PERÚ",
      "SUDAMERICANO ESCOLAR (JUGADOR)",
    ],
  },
  {
    ...
    text: [
      ...
      "ENTRENADOR SELECCIÓN NACIONAL",
      "ENTRENADOR SELECCIÓN DE LIMA",
      "JUEGOS PANAMERICANOS MAXIBASKET",
      "JUEGOS BOLIVARIANOS",
      "SUDAMERICANO FIBA",
      "SUDAMERICANO ESCOLAR",
      "CAMPEÓN LIGA DE LIMA",
      "CAMPEÓN NACIONAL DE LOS JUEGOS ESCOLARES",
      "CAMPEÓN ADECORE",
      "EX ENTRENADOR CLUB DE REGATAS DE LIMA",
    ],
  },
  {
  ...
  },
  {
    ...
    text: [
      ...
      "ENTRENADOR SELECCIÓN NACIONAL",
      "EX ENTRENADOR OBRAS (ARG)",
      "EX ENTRENADOR UNIÓN FLORIDA (ARG)",
      "EX ENTRANDOR CLUB DE REGATAS DE LIMA",
      "CAMPEÓN LIGA DE LIMA",
